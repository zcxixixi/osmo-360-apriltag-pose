...
from .devices import DEFAULT_INVENTORY, assign_device, load_inventory, register_devices, scan_devices
...
<div class="toolbar"><button class="button secondary" id="scan">扫描已连接 X5</button><button class="button" id="register">登记全部</button><div class="status" id="status">准备就绪</div></div><div class="error" id="error"></div>
...
document.getElementById('scan').onclick=scan;document.getElementById('register').onclick=register;load().catch(showError);
</script></body></html>'''
